...
_$_ResolutionDataObject _$$_ResolutionDataObjectFromJson(
    ...
    _$_ResolutionDataObject(
      ...
      basises:
          (json['basises'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
Map<String, dynamic> _$$_ResolutionDataObjectToJson(
        _$_ResolutionDataObject instance) =>
    <String, dynamic>{
